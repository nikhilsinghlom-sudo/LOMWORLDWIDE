...
<body cz-shortcut-listen="true">
    <div id="container mx-auto">
        <main id="main" class="">
            ...
            <div class="socialIcons d-flex align-items-center justify-content-center">
                <a href="https://www.facebook.com/profile.php?id=100067923949129#" target="_blank" class="text-decoration-none"><i class="fa-brands fa-facebook-f"></i></a>
                <a href="https://www.instagram.com/lomdigital?igshid=1iy98n2rl7dcb" target="_blank" class="text-decoration-none"><i class="fa-brands fa-instagram"></i></a>
                <a href="https://www.linkedin.com/company/lom-digital/posts/?feedView=all" target="_blank" class="text-decoration-none"><i class="fa-brands fa-linkedin-in"></i></a>
            </div>
            ...
            <section class="videoContainer">
                <section class="homeHeader anima in inited" id="home-header" data-anima-delay="4">
                    ...
                    <div class="homeHeader__content">
                        <h1 class="h0 homeHeader__heading zero h-anim anima spanned in" data-spanner="w" data-anima-delay="3">
                            <p>
                                <span class="w" data-i="1">Helping </span>
                                <span class="split"></span>
                                <span class="w" data-i="2">Brands Glow </span>
                            </p>
                            <p>
                ...
                <section class="homeHeader anima in inited" id="home-header" data-anima-delay="4">
                    ...
                    <div class="homeHeader__content">
                        <h1 class="h0 homeHeader__heading zero h-anim anima spanned in" data-spanner="w" data-anima-delay="3">
                            <p>
                                <span class="w" data-i="1">Influencers</span>
                ...
                <section class="homeHeader anima in inited" id="home-header" data-anima-delay="4">
                    <div class="homeHeader__mediaCards homeHeader__mediaCards2 mediaImageTwo">
                        <div class="homeHeader__mediaCard mediaImageTwo">
                            <video src="staging/Standard_Mode_Animate_the_character_animate_ha.mp4" class="media vid " autoplay="" muted="" loop="true" ?w=320&amp;h=560&amp;auto=compress%2Cformat&amp;fit=crop&amp;dm=1733156415&amp;s=d2a0bf388444e9e1d7f6dc7d78ec352e></video>
                        </div>
                    </div>
                    <div class="homeHeader__content">
                        <h1 class="h0 homeHeader__heading zero h-anim anima spanned in" data-spanner="w" data-anima-delay="3">
