    ...
    <div id="container">
        <main id="main" class="">
                ...
                <div>
                    <div class="slider" onmouseleave="hideHoverImages()">
                        ...
                        <!-- <div class="slide-track">
                            ...
                            <div class="slide" data-images="staging/amex1.1.png,staging/amex1.3.png,staging/amex1.2.png"
                                onmouseenter="showHoverImages(this)">
                                <div class="companyWork">
                                    <img src="staging/amexMain.png" alt="Project Image" />
                                </div>
                                <div class="companyLogo">
                                    <img src="staging/amexLogo.svg" alt="Company Logo">
                                </div>
                            </div>
                            <div class="slide" data-images="staging/hobnobs1.1.png,staging/hobnobs1.2.png,staging/hobnobs1.3.png"
                                onmouseenter="showHoverImages(this)">
                                <div class="companyWork">
                                    <img src="staging/hobnobsMain.png" alt="Project Image" />
                                </div>
                                <div class="companyLogo">
                                    <img src="staging/hobnobsLogo.png" alt="Company Logo">
                                </div>
                            </div>
                            <div class="slide" data-images="staging/mcvities1.1.jpg,staging/mcvities1.2.png,staging/mcvities1.3.jpg"
                                onmouseenter="showHoverImages(this)">
                                <div class="companyWork">
                                    <img src="staging/mcvitiesMain.jpg" alt="Project Image" />
                                </div>
                                <div class="companyLogo">
                                    <img src="staging/Mcvities.png" alt="Company Logo">
                                </div>
                            </div>
                            <div class="slide" data-images="staging/eternia1.1.jpg,staging/eternia1.2.png,staging/eternia1.3.jpg"
                                onmouseenter="showHoverImages(this)">
                                <div class="companyWork">
                                    <img src="staging/eterniaMain.jpg" alt="Project Image" />
                                </div>
                                <div class="companyLogo">
                                    <img src="staging/Eternia.png" alt="Company Logo">
                                </div>
                            </div>
                            <div class="slide" data-images="staging/nivaBupa1.1.png,staging/nivaBupa1.2.png,staging/nivaBupa1.3.png"
                                onmouseenter="showHoverImages(this)">
                                <div class="companyWork">
                                    <img src="staging/nivaBupaMain.png" alt="Project Image" />
                                </div>
                                <div class="companyLogo">
                                    <img src="staging/Niva-Bupa-Logo.svg" alt="Company Logo">
                                </div>
                            </div>
                            <div class="slide" data-images="staging/marengo1.1.png,staging/marengo1.2.png,staging/marengo1.3.png"
                                onmouseenter="showHoverImages(this)">
                                <div class="companyWork">
                                    <img src="staging/marengoMain.png" alt="Project Image" />
                                </div>
                                <div class="companyLogo">
                                    <img src="staging/marengoLogo.png" alt="Company Logo">
                                </div>
                            </div>
            ...
            <div class="testimonials">
                <p class="testiHeading text-center">What Our <span class="text-yellow">Client</span> Says</p>
                <div class="testiCont">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide testiBox scroll anima smd fade" data-anima-delay="5">
                                ...
                                <div class="testiContent text-center">
                                    <p class="comment pt-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Impedit quo est aperiam quam Lorem ipsum dolor sit amet.</p>
                                    <div class="imgCont">
                                        <img src="staging/artistic-frames-balFAEulzs8-unsplash-03.webp" alt="">
                                    </div>
                                    <p class="name">Chris Newman</p>
                                    <p class="position pt-2">Web Developer</p>
                                </div>
                            </div>
                            <div class="swiper-slide testiBox scroll anima smd fade" data-anima-delay="6.5">
                                <p class="quote text-center"><i class="fa-solid fa-quote-left text-yellow"></i></p>
                                <div class="testiContent text-center">
                                    <p class="comment pt-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Impedit quo est aperiam quam Lorem ipsum dolor sit amet.</p>
                                    <div class="imgCont">
                                        <img src="staging/artistic-frames-balFAEulzs8-unsplash-04.webp" alt="">
                                    </div>
                                    <p class="name">Vickie</p>
                                    <p class="position pt-2">Digital Marketer</p>
                                </div>
                            </div>
                            <div class="swiper-slide testiBox scroll anima smd fade" data-anima-delay="8">
                                <p class="quote text-center"><i class="fa-solid fa-quote-left text-yellow"></i></p>
                                <div class="testiContent text-center">
                                    <p class="comment pt-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Impedit quo est aperiam quam Lorem ipsum dolor sit amet.</p>
                                    <div class="imgCont">
                                        <img src="staging/artistic-frames-balFAEulzs8-unsplash-05.webp" alt="">
                                    </div>
                                    <p class="name">Emily Johnson</p>
                                    <p class="position pt-2">Digital Marketer</p>
                                </div>
                            </div>
                            <div class="swiper-slide testiBox scroll anima smd fade" data-anima-delay="9.5">
                                <p class="quote text-center"><i class="fa-solid fa-quote-left text-yellow"></i></p>
                                <div class="testiContent text-center">
                                    <p class="comment pt-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Impedit quo est aperiam quam Lorem ipsum dolor sit amet.</p>
                                    <div class="imgCont">
                                        <img src="staging/artistic-frames-balFAEulzs8-unsplash-06.webp" alt="">
                                    </div>
                                    <p class="name">John Doe</p>
                                    <p class="position pt-2">Influencer</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="callToAction__inner buttonHover">
                    <h2 class="h0 callToAction__heading h-anim anima spanned in" data-spanner="w">
                        <p><span class="w" data-i="1">Let’s </span>
                            <span class="window">
                                <picture>
                                    <source srcset="staging/medium-shot-happy-girl-amusement-park.webp?w=120&amp;h=110&amp;q=85&amp;auto=format&amp;fit=crop&amp;dm=1728475191&amp;s=8f125c43df46e56558e4a8a912f6d5bf 1x, staging/medium-shot-happy-girl-amusement-park.webp?w=240&amp;h=220&amp;q=85&amp;auto=format&amp;fit=crop&amp;dm=1728475191&amp;s=b444caae8c8053615f2aac1babebf934 2x" media="(max-width: 800px)">
                                    <source srcset="staging/medium-shot-happy-girl-amusement-park.webp?w=240&amp;h=220&amp;q=85&amp;auto=format&amp;fit=crop&amp;dm=1728475191&amp;s=b444caae8c8053615f2aac1babebf934 1x, staging/medium-shot-happy-girl-amusement-park.webp?w=480&amp;h=440&amp;q=85&amp;auto=format&amp;fit=crop&amp;dm=1728475191&amp;s=6cd839a3dfa6aafef22307458b04fe73 2x" media="(min-width: 800px)">
