    ...
    <div id="container">
        <main id="main" class="">
            <div class="blogSection">
                <section class="blogHeader text-center">
                    <p class="blogHeading mb-5">Blogs</p>
                    <p class="blogSubHeading">Where Strategy Meets Storytelling — Stay Ahead in Marketing.</p>
                </section>
                <div class="blogGrids">
                    <div class="blog">
                        <p class="">Personal, Stories * 4 min read</p>
                        <p class="blogTitle py-3 lh">Creativo Para Jóvenes: a Designer’s UI/UX Complete Checklist.</p>
                        <p class="blogContent lh mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ea rerum, eos deserunt eaque eius corporis et cupiditate facilis numquam tempore...</p>
                        <a href="">Read more <i class="fa-solid fa-arrow-right"></i></a>
                        <p class="blogAuthor mt-4">Posted by Admin</p>
                    </div>
                    <div class="blog">
                        <p class="">Personal, Stories * 4 min read</p>
                        <p class="blogTitle py-3 lh">Creativo Para Jóvenes: a Designer’s UI/UX Complete Checklist.</p>
